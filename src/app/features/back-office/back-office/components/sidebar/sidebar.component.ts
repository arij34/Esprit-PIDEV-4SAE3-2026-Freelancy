...
<div class="h-16 flex items-center px-6 border-b border-gray-50">
  ...
  <button *ngIf="isMobile"
      ...
      <div class="p-4 border-t border-gray-50">
        <button (click)="logout()" class="flex items-center w-full p-2 text-gray-500 hover:text-red-500 hover:bg-red-50 rounded-lg transition-colors">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export class SidebarComponent {
  ...
  get showOverlay(): boolean {
    ...
    if (typeof window === 'undefined') return this.isMobile;
  ...
  mainMenuItems: MenuItem[] = [
    ...
    {
      icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 3.104v5.714a2.143 2.143 0 01-2.143 2.143H1.893M14.25 20.896v-5.714a2.143 2.143 0 012.143-2.143h5.714M14.25 3.104h4.286a2.143 2.143 0 012.143 2.143v4.286M9.75 20.896H5.464a2.143 2.143 0 01-2.143-2.143v-4.286"></path></svg>',
      label: 'Exam & Quiz',
      key: 'examQuiz'
    },
    {
  ...
  managementMenuItems: MenuItem[] = [
    ...
    {
      icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 19h16M4 15h10M4 11h7M4 7h13"/></svg>',
      label: 'Statistique abonnement/payement',
